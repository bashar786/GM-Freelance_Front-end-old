...
function Footer() {
  return (
    <div className="bg-gradient-to-r from-[#191716] to-[#361601] py-10">
      <div className="flex flex-col items-center justify-center lg:flex-row lg:justify-evenly lg:py-0">
        ...
        <div>
          ...
          <div className="flex flex-col items-center justify-between h-28 my-5 sm:w-[400px] md:w-[470px] md:flex-row lg:w-[400px]">
            <input
              type="email"
              placeholder="@ e-mail"
              className="bg-white px-4 py-2 w-[250px] rounded-full sm:w-[80%] md:w-[60%] lg:w-[140%] lg:px-0"
            />
      ...
      <div className="md:pl-[120px] lg:pl-[70px]">
        <div className="flex  items-center justify-center h-[70px] sm:flex-row md:flex-row md:justify-start">
          {/*Social Icons */}
          <div className="flex flex-col items-center justify-center sm:flex-row sm:w-[250px] sm:justify-evenly">
            <p className="text-white text-xl px-5">Follow Us</p>
            <p className="flex items-center justify-between w-[70px]">
